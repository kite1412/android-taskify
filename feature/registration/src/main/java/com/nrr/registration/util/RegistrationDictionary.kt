package com.nrr.registration.util

import com.nrr.registration.R

internal object RegistrationDictionary {
    val changeLater = R.string.registration_change_later
